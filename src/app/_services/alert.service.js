...
var AlertService = /** @class */ (function () {
    ...
    AlertService.prototype.success = function (message, options) {
        this.alert(new _models_1.Alert(__assign(__assign({}, options), { type: _models_1.AlertType.Success, message: message })));
    };
    AlertService.prototype.error = function (message, options) {
        this.alert(new _models_1.Alert(__assign(__assign({}, options), { type: _models_1.AlertType.Error, message: message })));
    };
    AlertService.prototype.info = function (message, options) {
        this.alert(new _models_1.Alert(__assign(__assign({}, options), { type: _models_1.AlertType.Info, message: message })));
    };
    AlertService.prototype.warn = function (message, options) {
        this.alert(new _models_1.Alert(__assign(__assign({}, options), { type: _models_1.AlertType.Warning, message: message })));
    };
    // main alert method    
    ...
    AlertService.prototype.clear = function (id) {
        if (id === void 0) { id = this.defaultId; }
        this.subject.next(new _models_1.Alert({ id: id }));
    };
